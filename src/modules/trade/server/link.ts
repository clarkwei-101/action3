...
// SQLite: Prisma generates string constants instead of enums
const LINK_STORAGE_DATA_TYPE = 'CHAT_V1' as const;
const LINK_STORAGE_VISIBILITY_UNLISTED = 'UNLISTED' as const;
...
const dataTypesSchema = z.enum([LINK_STORAGE_DATA_TYPE]);
    ...
    .mutation(async ({ input }) => {
      ...
      const { id: objectId, ...rest } = await prismaDb.linkStorage.create({
        ...
        data: {
          ...
          visibility: LINK_STORAGE_VISIBILITY_UNLISTED,
          dataType,
          dataTitle,
